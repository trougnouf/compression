...
class Balle2018PTTFExp_ImageCompressor(abstract_model.AbstractHyperpriorImageCompressor):
    '''
    This is the one
    '''
...
class Balle2018PT_ImageCompressor(abstract_model.AbstractHyperpriorImageCompressor):
    def __init__(self, out_channel_N=192, out_channel_M=320, lossf='mse', device='cuda:0', entropy_coding=False, **kwargs):
        super().__init__(out_channel_N=out_channel_N, out_channel_M=out_channel_M, lossf=lossf, device=device, entropy_coding=entropy_coding, **kwargs)
        self.Encoder = Analysis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
        self.Decoder = Synthesis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
...
class Balle2018PTStd_ImageCompressor(abstract_model.AbstractHyperpriorImageCompressor):
    def __init__(self, out_channel_N=192, out_channel_M=320, lossf='mse', device='cuda:0', entropy_coding=False, **kwargs):
        super().__init__(out_channel_N=out_channel_N, out_channel_M=out_channel_M, lossf=lossf, device=device, entropy_coding=entropy_coding, **kwargs)
        self.Encoder = Analysis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
        self.Decoder = Synthesis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
...
class Balle2018PTTF_ImageCompressor(abstract_model.AbstractHyperpriorImageCompressor):
    def __init__(self, out_channel_N=192, out_channel_M=320, lossf='mse', device='cuda:0', entropy_coding=False, **kwargs):
        super().__init__(out_channel_N=out_channel_N, out_channel_M=out_channel_M, lossf=lossf, device=device, entropy_coding=entropy_coding, **kwargs)
        self.Encoder = Analysis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
        self.Decoder = Synthesis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
...
class Balle2018PTPaperExp_ImageCompressor(abstract_model.AbstractHyperpriorImageCompressor):
    def __init__(self, out_channel_N=192, out_channel_M=320, lossf='mse', device='cuda:0', entropy_coding=False, **kwargs):
        super().__init__(out_channel_N=out_channel_N, out_channel_M=out_channel_M, lossf=lossf, device=device, entropy_coding=entropy_coding, **kwargs)
        self.Encoder = Analysis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
        self.Decoder = Synthesis_net(out_channel_N=out_channel_N, out_channel_M=out_channel_M)
